...
//CODE HERE
const compareNums = (num1, num2) => console.log(num1 > num2 ? num1 : num2);
...
const nameGreeting = nameCheck("Andrew");
...
function faveColorFinder(color) {
    if(color === "red") {
        ...
        console.log("green is solid favorite color");
    } else if(color === "black") {
        console.log("so trendy");
    } else {
        console.log("you need to evalutate your favorite color choice")
    }
}
...
function thatsOdd(num) {
    console.log(num % 2 === 0 ? "That's not odd!" : "That is odd indeed!");
}
...
//CODE HERE
function theEliminator(array, name) {
...
function emailCheck(email) {
    ...
    return email.includes("@") ? "email verified" : "must provide valid email address";
}

console.log(emailCheck("email@address"))
...
console.log(checkArray(sampleArray));
